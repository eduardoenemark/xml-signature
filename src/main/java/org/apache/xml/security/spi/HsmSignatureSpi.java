 ...
 * @author eduardo
 */
public class HsmSignatureSpi extends SignatureSpi {
    ...
    protected void engineInitSign(PrivateKey privateKey) throws InvalidKeyException {
        throw new UnsupportedOperationException("engineInitSign: Not supported yet.");
    }

    @Override
    protected void engineUpdate(byte b) throws SignatureException {
        throw new UnsupportedOperationException("engineUpdate: Not supported yet.");
    }
    ...
    protected byte[] engineSign() throws SignatureException {
        throw new UnsupportedOperationException("engineSign: Not supported yet.");
    }
